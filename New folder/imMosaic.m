function [matchLoc1 matchLoc2 num H corrPtIdx] = imMosaic( img1,img2,adjColor )
...
kkk = 1;
distRatio = 0.85;
[matchLoc1 matchLoc2 num] = siftMatch(img1,des1, loc1, img2, kkk, distRatio)

% use RANSAC to find homography matrix

[H,X1inliers, X2inliers,corrPtIdx] = homRANSAC(matchLoc1,matchLoc2);

% [H corrPtIdx] = findHomography(matchLoc1',matchLoc2');

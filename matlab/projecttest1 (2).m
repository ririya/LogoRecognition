...
% %%
% 
% logo1 = imread('cocacolalogo.jpg');
% 
% [x1 y1 v1]= harris(logo1);
% r1= ones(length(x1),1);
% r1 = r1*5;
% sif1 = find_sift(logo1,[x1 y1 r1],1.5);
% 
...
% end
% 
% im1_pts = [x1(im1pts) y1(im1pts)];im1_pts=im1_pts';
% im11_pts = [x(im2pts) y(im2pts)];im11_pts=im11_pts';
...
% show features detected in image 1
plot(im1_pts(1,aaa),im1_pts(2,aaa),'+g') ;
% show displacement s
